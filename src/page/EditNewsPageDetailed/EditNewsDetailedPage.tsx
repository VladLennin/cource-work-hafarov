...
import css from "./EditNewsDetailedPage.module.css"
...
const EditNewsDetailedPage = () => {
    ...
    const handleSubmit = (e: any) => {
        e.preventDefault();
        $api.put(`/news/${news.id}`, news).then(() => {
            handleShowToast()
        }).then(() => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div>
                <Title value={"Редагування новини 🔧"}/>
                {isLoading ? <Skeleton/> :
                    <div className={css.createNewsContainer}>
                        <div className={css.section}>
                            <span className={css.subtitle}>Заголовок</span>
                            <input defaultValue={news.title} required className={css.titleInput} onChange={e => {
                                setNews({...news, title: e.target.value})
                            }}/>
                        </div>

                        <div className={css.section}>
                            <span className={css.subtitle}>Дата</span>
                            <input type={"date"} required className={css.titleInput} onChange={e => {
                                setNews({...news, date: new Date(e.target.value)})
                            }}/>
                        </div>
...
export default EditNewsDetailedPage;